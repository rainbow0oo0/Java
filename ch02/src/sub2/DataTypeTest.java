...
public class DataTypeTest {
	...
	public static void main(String[] args) { // 메인 메서드에서 코딩중
		
		// 정수형
		byte	num1 = 127;			// 1byte
		short	num2 = 32767;		// 2byte
		char	num3 = 97;			// 2byte
		int		num4 = 214783647;	// 4byte
		...
		// 문자형
		char c1 = 'A';		// c1 변수명은 아무렇게 해도 상관없음
		char c2 = '가';
		
		System.out.println("c1 : " + c1);
		System.out.println("c2 : " + c2);
		
		int n1 = c1; // car는 정수형 타입이기 때문에 int형으로 대입가능, int, char등 이름 빨간색
