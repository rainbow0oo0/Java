...
public class StringTest {
	...
	// 문자열 비교 
	if(str1 == str2) { 	
		System.out.println("str1, str2 문자열이 주소값 같다.");
	}else {
		System.out.println("str1, str2 문자열이 주소값 다르다,");
	}
	if(str1.equals(str2)) { // 문자열 비교할때 반드시 equals 비교
	...
	// 문자열 인덱스
	int idx1 = message.indexOf('e');		// 문자열의 앞에서 부터 문자 e 탐
	...
	// String s1 = var1; 의도 var1을 string에 담으려고 한다
	String s1 = String.valueOf(var1);
	String s2 = String.valueOf(var2); 
	String s3 = ""+var3; // 빈문자열을 가지고 변환
	// String.valueOf(var2) = ""+var2
